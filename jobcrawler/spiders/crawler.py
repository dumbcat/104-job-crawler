...
class JobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        url = (f'https://www.104.com.tw/jobs/search/?ro=0&jobcat=2005002004&jobcatExpansionType=0&area=6001016008&order=11&asc=0&page=1&mode=s&jobsource=n_my104_search')
        yield scrapy.Request(
            url=url,
            callback=self.parse,
            cb_kwargs={'areades': '高雄市三民區',})

    def parse(self, response, areades):
        ...
        # Not include job advertisements when parsing
        # targets = sel.xpath(
